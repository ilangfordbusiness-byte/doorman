...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col px-5 pt-2 pb-6 max-w-lg mx-auto">
      {/* Brand */}
      <div className="flex items-center gap-1 mb-1">
        <img src="https://media.base44.com/images/public/69d556d1ae7f4cada8ab83ef/e327a8610_logotransparent.png" alt="DoorMan" className="w-36 h-36 object-contain outline-none" />
