...
// local dev (vite dev server) for testing against seeded users.
      ...
      <div className="w-full max-w-sm text-center">
        ...
        {import.meta.env.DEV && (
          ...
          >
            ...
            <button
              disabled={busy}
              className="w-full rounded-lg bg-primary text-primary-foreground px-3 py-2 text-sm font-semibold disabled:opacity-50"
            >
              Sign in
            </button>
          </form>
