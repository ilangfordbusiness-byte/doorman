-- ===========================================================================
-- Keep the "Smoke host" seed/test account out of friend suggestions.
--
-- Smoke host (akshay.irudayaraj+dm-host@gmail.com) is a smoke-test account that
-- can't be deleted yet — it owns a paid ticket order. Until it's removed, hide
-- it from the Activity → Suggestions list so real users aren't offered it.
--
-- Reproduces get_friend_suggestions from 20260825140000_dashboard_rpcs.sql
-- verbatim, with one extra predicate excluding that email.
-- ===========================================================================
